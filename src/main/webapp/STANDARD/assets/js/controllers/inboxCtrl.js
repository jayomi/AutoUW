...
function($scope, $state, $interval) {
	$scope.noAvatarImg = "STANDARD/assets/images/default-user.png";
	var date = new Date();
	var d = date.getDate();
	var m = date.getMonth();
	...
	$scope.messages = [{
		...
		"avatar" : "STANDARD/assets/images/avatar-6.jpg",
		"starred" : false,
		"sent" : false,
		"spam" : false,
		"read" : false,
		...
		"avatar" : "STANDARD/assets/images/avatar-9.jpg",
		"starred" : true,
		"sent" : false,
		"read" : true,
		"spam" : false,
		...
		"avatar" : "STANDARD/assets/images/avatar-8.jpg",
		"starred" : false,
		"sent" : false,
		"read" : true,
		"spam" : false,
		...
		"avatar" : "STANDARD/assets/images/avatar-3.jpg",
		"starred" : false,
		"sent" : false,
		"spam" : false,
		...
		"avatar" : "STANDARD/assets/images/avatar-2.jpg",
		"starred" : false,
		"sent" : false,
		"read" : true,
		"spam" : false,
		...
		"avatar" : "STANDARD/assets/images/avatar-5.jpg",
		"starred" : false,
		"sent" : false,
		"read" : true,
		"spam" : false,
